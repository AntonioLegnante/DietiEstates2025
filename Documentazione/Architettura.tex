...
Ogni componente dell'applicazione (backend Spring Boot, frontend React, NGINX, PostgreSQL, MinIO, Cloudflared) viene eseguito in container Docker indipendenti. Il backend
