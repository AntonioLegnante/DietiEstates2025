...
\end{itemize}
\textbf{Descrizione:} \\
Il sistema deve permettere la registrazione di nuovi utenti (clienti) e di agenti immobiliari. 
Tutti gli attori devono essere in grado di effettuare il login con credenziali sicure. 
L’Amministratore deve poter modificare le credenziali di accesso predefinite e gestire gli account degli agenti.
\\ \\
